...
| Sorgente | **29 TypeScript** · 5 JavaScript · 5 CSS · `index.html` — `modules/parametri.ts` e `modules/destinatari.ts` dalla 1.6 |
...
| Collaudi | **435 client** (~1,7 s) + **55 servizio** + 8 migrazione — verdi |
