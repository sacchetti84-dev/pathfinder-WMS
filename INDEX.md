...
2. **Il primo comando di ogni conversazione che tocchi la consegna è
   `Invoke-RestMethod http://127.0.0.1:4173/api/app-info`.** Quello che
   risponde il servizio batte quello che dice questo documento. È successo
   **quattro volte in cinque giorni** che il documento dicesse la versione
   sbagliata (voci 35 e 48-bis), e la quinta è documentata in §1.
