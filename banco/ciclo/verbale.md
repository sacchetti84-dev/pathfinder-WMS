...
Documento `RES-PROVA20-MTT8YF0Y` registrato · giacenza 59 KG (invariata) · fisici 3 coll., disponibili 2
...
`TA-MTT8YF6N-POSU` · stato in_progress · preso da ANDS · avviato sì
...
Compito `TA-MTT8YGK1-MBY8` in coda, stato requested
...
`_format` **warehouse-mapper-v1.5** · `_appVersion` **2.37.0** · collezioni previste 19
Verifica: **passa**
