...
export const SUPERFICIE = [
  ...
  '_blockedByReadOnly', '_buildPickReportHTML', '_buildRegistryTable', '_cambioLookup',
  ...
  '_contaSelect', '_contaState', '_datalistUM', '_dateISOtoIT', '_dateITtoISO',
  ...
  '_moveItemDestPreview', '_moveSelection', '_normScan', '_notaUM', '_ntCercaArticolo',
  ...
  '_qSwitchToAlternative', '_quarantineItemCore', '_queueFailedMovement', '_rcpFiltro',
  ...
  '_requireOperator', '_retryService', '_rigaUM', '_ristampaVerbaleCampione',
  ...
  '_routeResume', '_routeSave', '_routeScan', '_routeSiteOrderHTML', '_routeStage',
