...
export const SUPERFICIE = [
  ...
  '_autoLookupArticle', '_avvisiArticolo', '_avvisiBanda', '_badgeUdc', '_avvisiRigaStampa',
  ...
  '_ancoraLaCoda', '_regoleDellaCarta',
  ...
  '_chiediColli', '_chiudiCompitoDelPercorso', '_chioscoHTML', '_closeIdentityGate', '_closePickLoc', '_colliIn', '_colliInChiave',
  ...
  '_routeSetCasa',
  '_umTotaliRiga', '_vaiAUdc', '_vanoDaCampo', '_vanoDetto', '_dettaglioItem', '_stampaEtichettaItem',
  '_vistaDiZona', '_udcInMano', '_udcNelVanoHTML', '_udcPosa', '_udcPrendi', '_udcSpostaDaPannello', '_udcTrascinata', '_toccaVano', '_udcDelVanoHTML', '_udcDragStart', '_udcDragOver',
  ...
  '_execReleaseDest', '_execSmaltire', '_fasciaConformita', '_fasciaInMano', '_filterRegistry',
  ...
  '_odpAvvia', '_routeLeggiFile', '_pfDeposita', '_pfVanoDiZona',
