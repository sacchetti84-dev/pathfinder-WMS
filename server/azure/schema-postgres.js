...
/* LO SCHEMA POSTGRESQL, GENERATO DALLA STESSA DICHIARAZIONE — 2.1.
   © Andrea Sacchetti — Dietopack S.r.l. (Naturacare Group)

   RAMO PARALLELO. Questo file NON è in servizio e non lo chiama nessuno:
   la produzione gira su SQLite, e §6 dice «niente Azure». Sta qui perché la
   richiesta del 19/08/2026 è di preparare schema e migrazione senza
   toccare quello che lavora — così il giorno che la decisione si prende,
   c'è già, e nel frattempo non c'è un ramo di codice che nessuno percorre
   dentro l'applicativo vero.
...
module.exports = { colTypePg, createTableSQL, createIndexSQL, createSQL, schemaCompleto };
